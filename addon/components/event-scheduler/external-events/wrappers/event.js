...
import { getEventPeriod } from '../../../../utils/event-scheduler';
...
export default Component.extend({
  ...
  eventPeriod: computed('event.{startTime,endTime}', function() {
    let { startTime, endTime } = this.get('event');
    return getEventPeriod(startTime, endTime, dateTimeFormat, timeFormat, this.get('moment'));
  })
});
